...
function ProjectDetails() {
  ...
  return (
    <>
      <div className="bg-white flex gap-2 justify-center items-start box-shadow-1 rounded-md px-5 py-4 ">
        {/* LEFT SIDE: Project Info */}
        <div className="w-[20%] px-3 bg-black rounded-md p-2 text-white">
          <h1 className="text-3xl font-bold mb-5">PROJECT- 856 </h1>
          <h2 className="text-lg font-bold">company</h2>
          <h2 className="text-xl font-normal mb-4">UGVCl</h2>
          <h2 className="text-lg font-bold">PROJECT <br /> IN-CHARGE</h2>
          <h2 className="text-lg font-normal mb-4">Bansal Patel</h2>
          <h2 className="text-lg font-bold">PROJECT <br /> ENGINEER</h2>
          <h2 className="text-lg font-normal mb-5">Bansal Patel</h2>
          <h2 className="text-lg font-bold">STORE ID</h2>
          <h2 className="text-lg font-normal"> S121</h2>
        </div>

        {/* RIGHT SIDE */}
        <div className="w-[80%] rounded-md mt-0">
  ...
  <BarChart data={projectWiseData}>
    ...
    {/* Bars in different shades of black/gray */}
    <Bar dataKey="in" fill="#1a1a1a" />     {/* Dark black */}
    <Bar dataKey="out" fill="#4d4d4d" />    {/* Medium gray */}
    <Bar dataKey="return" fill="#b3b3b3" /> {/* Light gray */}
  </BarChart>
</ResponsiveContainer>
          ...
          <div className="flex flex-col lg:flex-row gap-6">
            ...
            <div className="lg:w-[40%] border border-black rounded-lg bg-white p-2 shadow-sm">
              <h2 className="text-lg font-semibold mb-4">WORKING LOCATION</h2>
              <div className="overflow-x-auto">
                <table className="w-full text-sm">
                  <thead>
                    <tr className="text-start border-b">
                      <th className="pb-3 min-w-[120px]">No</th>
                      <th className="pb-3 min-w-[80px]">Locations</th>
                    </tr>
                  </thead>
                  <tbody>
            ...
            <div className="lg:w-[60%] border border-black rounded-lg bg-white p-5 shadow-sm overflow-x-auto">
